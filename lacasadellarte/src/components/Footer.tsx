...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-beige-dark)] mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <div
                className="w-10 h-10 rounded-full bg-[var(--color-accent)] flex items-center justify-center hover:bg-[var(--color-gold)] transition-colors cursor-pointer"
                aria-label="Facebook"
              >
          ...
          <div className="md:text-right">
            ...
            <div className="space-y-3 text-[var(--color-gray)]">
              ...
              <div className="flex items-center md:justify-end space-x-2">
                ...
                <a href="mailto:ladellaarte@gmail.com" className="hover:text-[var(--color-accent)] transition-colors">
        ...
        <div className="border-t border-[var(--color-accent)]/20 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm text-[var(--color-gray)]">
