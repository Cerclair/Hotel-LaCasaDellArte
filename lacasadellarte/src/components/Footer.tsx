  ...
  return (
    <>
      ...
      <footer className="bg-[#E8E4D8] mt-auto border-t-2 border-[var(--color-accent)]/10">
        <div
          className="container mx-auto px-4 md:px-6 lg:px-8 pb-6"
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-3 flex flex-col items-center lg:items-start">
              ...
              <Link
                href="/"
                className="flex items-center gap-2 md:gap-4 mb-4 transition-all duration-300 group"
              >
                <div
                  className="relative w-12 h-12 md:w-16 md:h-16 rounded-full overflow-hidden shadow-lg footer-logo-ring"
                ...
                <div className="flex flex-col">
                  <span
                    className="text-lg md:text-2xl font-bold text-[var(--color-text)] tracking-tight"
                    style={{
              ...
              <div className="flex gap-2">
                ...
                >
                  <Image
                    ...
                    style={{
                      filter:
                        "brightness(0) saturate(100%) invert(44%) sepia(13%) saturate(854%) hue-rotate(353deg) brightness(95%) contrast(88%)",
                    }}
                  />
                </a>
            ...
            <div className="lg:col-span-3 flex items-start justify-center lg:justify-end">
              <div className="space-y-2 text-center lg:text-right">
                ...
                <div className="flex items-center justify-center lg:justify-end gap-2 text-[var(--color-text)]">
                  <svg
                    className="w-4 h-4 md:w-5 md:h-5 text-[var(--color-accent)] flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center gap-3">
              ...
              <div
                ...
                style={{ fontSize: "13px" }}
              >
                &copy; {new Date().getFullYear()} La Casa Dell&apos;Arte. All
                rights reserved.
              </div>
