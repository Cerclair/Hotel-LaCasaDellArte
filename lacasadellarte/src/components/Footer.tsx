        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex gap-3 mt-6">
              <div
                className="w-10 h-10 rounded-full bg-[var(--color-accent)] flex items-center justify-center hover:bg-[var(--color-accent)]/80 hover:scale-110 transition-all duration-300 cursor-pointer shadow-md"
                aria-label="Facebook"
              >
            ...
            <div className="grid grid-cols-3 gap-8">
              ...
              <div>
                <nav className="flex flex-col space-y-3">
                  <Link
                    href="/"
                    className="text-sm font-medium text-[var(--color-text)] hover:text-[var(--color-accent)] transition-colors duration-300"
                  >
                    Home
                  </Link>
                  <Link
          ...
          <div className="lg:col-span-3">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-[var(--color-text)]">
                ...
                <span className="text-sm font-medium">+94 718 530 994</span>
              </div>
              ...
              <div className="flex items-center gap-3 text-[var(--color-text)]">
                ...
                <a
                  ...
                  className="text-sm font-medium hover:text-[var(--color-accent)] transition-colors duration-300"
                >
              ...
              <div className="flex items-start gap-3 text-[var(--color-text)]">
                ...
                <span className="text-sm font-medium">Galle Road, Colombo 03, Sri Lanka</span>
              </div>
            </div>
          </div>
